...
- **CLI Control:** You interact with and control the Odac server through the `candy` command-line tool. This tool allows you to start, stop, monitor, and manage your applications.
